...
По прежнему всё результат согласуется с заявленной вероятностью 95%
...
Видимо, методика построения ДИ, реализованная в fisher.test, при различных значениях p_R и p_T работает корректно.